// Historical broad-STEM one-shot qualification, not the current release gate.
...
function runSemanticReleaseExecution(
  ...
  run("bun", ["scripts/check-fresh-blind-reservation.ts", "--local"], {
    env: {
      SEMATH_CANDIDATE_SHA: candidateSha,
      SEMATH_FRESH_BLIND_FIXTURE: fixture,
