...
| Concepts, laws, quantities, units, dimensions | Pure semantic projection and exact dimension algebra; catalog validation, scoped propagation, engineering corpus, and collision fixtures | protocol/inspection shapes plus native/release-WASM exact parity | one meaning-first engineering inspection |
...
| Pack distribution | pure Rust/TypeScript schema-3 and catalog validation plus corpus gates | tarball install, exports, ABI/checksum checks | none |
